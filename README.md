...
<em>DensePhrases</em> 是一项由Korea University和Princeton University联合完成的，基于短语级的文本匹配（召回）模型，面向于自然语言理解（下称NLP）中开放域问答和阅读理解任务。其项目论文被收录于ACL2021(https://arxiv.org/abs/2012.12624)。
